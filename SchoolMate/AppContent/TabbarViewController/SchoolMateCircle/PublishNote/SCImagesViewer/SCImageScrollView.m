...
@interface SCImageScrollView () <UIScrollViewDelegate>
...
@implementation SCImageScrollView
...
- (void)setIndex:(NSUInteger)index {
    ...
    _index = index;
    UIImage *image = [[SCImagesViewerData sharedInstance] photoAtIndex:index];
    [self displayImage:image];
}

+ (NSUInteger)imageCount {
    
    return [[SCImagesViewerData sharedInstance] photoCount];
}
